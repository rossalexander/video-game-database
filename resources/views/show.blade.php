...
@section('content')
    <div class="container mx-auto px-4">
        <div class="flex border-b border-gray-800 pb-12">
            <div class="flex-none">
                <img src="/" alt="cover" class="w-48 h-64 bg-gray-500">
            </div>

            <div class="ml-12 mr-64">
                <h2 class="font-semibold text-4xl">Final Fantasy VII</h2>
...
<g>
    ...
    <path fill="white" d="M49,8.9c-2.6-2.7-6.3-4.1-10.5-4.1H17.9c-8.7,0-14.5,5.8-14.5,14.5v20.5c0,4.3,1.4,8,4.2,10.7c2.7,2.6,6.3,3.9,10.4,3.9
		...
		c3,0,5.5,0.9,7.3,2.7c1.7,1.8,2.7,4.3,2.7,7.2V39.9L48.6,39.9z"/>
                ...
                <p class="mt-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab architecto, asperiores
                    aspernatur beatae cum deserunt dolorem doloremque ea eos, error nemo numquam quibusdam quo quod
                    ratione soluta voluptatibus voluptatum. Accusantium esse eum explicabo hic molestias officia
                    quisquam vitae voluptas voluptate?
                </p>
        ...
        <div class="border-b border-gray-800 pb-12 mt-8">
            ...
            <div class="grid grid-cols-3 gap-12 mt-8">
                <a href="#">
                    <img src="" alt=""
                         class="bg-gray-700 w-48 h-24 hover:opacity-75 transition-colors ease-in-out duration-150">
                </a>
            </div>
        </div>
